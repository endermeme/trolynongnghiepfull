...
export default function Menu() {
  return (
      ...
      <div className="bg-white shadow-md rounded-lg">
        <MenuItem text={"Trợ lí nông nghiệp AI"} img_src="https://cdn3.iconfinder.com/data/icons/chatbot-robot/100/chatbot_01_16_bot_chat_robot_app_artificial_chatbot_dialog-1024.png" to="https://bow-comfortable-gilmoreosaurus.glitch.me/"/>
